...
class ArchitectureBoundaryTest {
    ...
    private static final JavaClasses CLASSES = new ClassFileImporter()
            ...
            .importPackages("org.example.finance");
    ...
    void layeredArchitectureCompliance() {
        ArchRule rule = layeredArchitecture()
                ...
                .layer("Controller").definedBy("org.example.finance.controller..")
                .layer("Service").definedBy("org.example.finance.service..")
                .layer("Repository").definedBy("org.example.finance.repository..")
    ...
    void repositoriesMustBeInterfacesAndEndWithRepository() {
        ArchRule rule = classes()
                .that().resideInAPackage("org.example.finance.repository..")
