...
public class SeasonCostOptimizationController {
    ...
    @GetMapping("/summary")
    public ApiResponse<SeasonCostOptimizationSummaryResponse> getSummary(@PathVariable Integer seasonId) {
        return ApiResponse.success(seasonCostOptimizationService.getSummary(seasonId));
    }
    ...
    public ApiResponse<SeasonCostOptimizationSuggestionResponse> generateSuggestion(
        ...
        return ApiResponse.success(seasonCostOptimizationService.generateSuggestion(seasonId, request));
    }
}
