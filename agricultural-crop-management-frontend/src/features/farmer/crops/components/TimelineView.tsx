        ...
        <CardContent>
          ...
          <div className="flex flex-col items-center justify-center py-16 text-center">
            ...
            <p className="text-sm text-muted-foreground max-w-md">
              Growth stage timeline will be available when connected to
              real-time API. Track sowing, vegetative, reproductive, and harvest
              stages with actionable insights.
            </p>
          </div>
        </CardContent>
      </Card>
