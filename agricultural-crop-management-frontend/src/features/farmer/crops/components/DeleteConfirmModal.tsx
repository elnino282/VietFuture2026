          ...
          {crop && (
            <div className="py-4 space-y-4">
              <div className="p-3 bg-gray-50 rounded-md">
                <p className="text-sm font-medium">Crop: {crop.cropType}</p>
              </div>
              <div className="space-y-2">
                <p className="text-sm font-medium text-gray-700">
                  Seasons using this crop:
                </p>
              ...
              <div className="p-3 bg-amber-50 border border-amber-200 rounded-md">
                <p className="text-sm text-amber-800">
                  <strong>Note:</strong> To delete this crop, you must first
                  remove it from all seasons or delete those seasons.
                </p>
              </div>
            </div>
          )}
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent>
        <DialogHeader>
          ...
          <DialogDescription>
            Are you sure you want to delete this crop record? This action cannot
            be undone.
          </DialogDescription>
        </DialogHeader>
        {crop && (
